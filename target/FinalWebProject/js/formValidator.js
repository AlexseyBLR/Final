function validateFormOnRegistration() {
    ...
    if (!phoneRegExp.test(phoneField)) {
        document.getElementById('phone_error').innerHTML = "*incorrect phone number. Input in format +375XXXXXXXXXXX";
        countOfErrors = countOfErrors + 1;
    } else {
